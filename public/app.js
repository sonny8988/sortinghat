(function(){
	...
	app.controller('UsersController', ['$scope', function($scope){
		...
		$scope.userImage = function(user){
			if(user.email){
				...
				return "http://www.gravatar.com/avatar/" + MD5(user.email) + "?s=150";
			} else {
				return "http://robohash.org/" + user.name + "?size=100x100";
			}
		};
	...
	var userList = [
		{
			name: 'Shu',
			email: 'seinan.shu@mail.rakuten.com',
			leader: true,
			showTeam: false
		},
		{
			name: 'Carroll',
			email: 'mitchell.carroll@mail.rakuten.com',
			leader: true,
			showTeam: false
		},
		{
			name: 'Kurapati',
			email: 'tarun.kurapati@mail.rakuten.com',
			leader: false,
			showTeam: false
		},
		{
			name: 'Meena',
			email: 'bhoor.meena@mail.rakuten.com',
			leader: false,
			showTeam: false
		},
		{
			name: 'Yang',
			email: 'chunya.yang@mail.rakuten.com',
			leader: false,
			showTeam: false
		},
		{
			name: 'Agarwal',
			email: 'ankit.agarwal@mail.rakuten.com',
			leader: false,
			showTeam: false
		},
		{
			name: 'Wicaksono',
			email: 'indra.wicaksono@mail.rakuten.com',
			leader: false,
			showTeam: false
		},
		{
			name: 'Nitadori',
			email: 'ts-maya.nitadori@mail.rakuten.com',
			leader: false,
			showTeam: false
		},
		{
			name: 'Saijo',
			email: 'ts-kiju.saijo@mail.rakuten.com',
			leader: false,
			showTeam: false
		},
		{
			name: 'Nishimura',
			email: 'ts-ayato.nishimura@mail.rakuten.com',
			leader: false,
			showTeam: false
		},
	];
